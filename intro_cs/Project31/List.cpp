...
void List::Insert(ListItemType item)
...
bool List::IsPresent(ListItemType item) const
...
void List::Delete(ListItemType item)
...
std::ostream& operator<<(std::ostream& os, const ListItemType& song)
{
    cout << setw(42) << left << song.artist << setw(51) << song.title << setw(3)
         << right << song.rank << endl;
